...
function getSurvey() {
  return fetch("https://wiz.medone.idf.il/mk/m/6u6dnt6a4e", {
    headers: {
      accept:
...
function getCaptcha(cookie) {
  return fetch("https://wiz.medone.idf.il/mk/captcha.aspx", {
    headers: {
...
function submitSurvey(cookie, captchaSolution, tz) {
  const date = new Date();
